						...
						<div class="row">
							<div class="col-12">
								<div class="single-main">
									<!-- News Head -->
									<div class="news-head">
										<img src="{{ asset('user/img/blog1.jpg')}}" alt="#"> }
									</div>
									<!-- News Title -->
									...
									<div class="meta">
										<div class="meta-left">
											<span class="author"><a href="#"><img src="{{ asset('user/img/author1.jpg')}}" alt="#">Naimur Rahman</a></span>
						...
						<div class="main-sidebar">
							...
							<div class="single-widget recent-post">
								...
								<div class="single-post">
									<div class="image">
										<img src="{{ asset('user/img/blog-sidebar1.jpg')}}" alt="#"> 
									</div>
									<div class="content">
								...
								<div class="single-post">
									<div class="image">
										<img src="{{ asset('user/img/blog-sidebar2.jpg')}}" alt="#">
									</div>
									<div class="content">
								...
								<div class="single-post">
									<div class="image">
										<img src="{{ asset('user/img/blog-sidebar3.jpg')}}" alt="#">
									</div>
									<div class="content">
