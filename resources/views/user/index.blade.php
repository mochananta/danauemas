...
@section('user')		
		...
		<section class="slider">
			<div class="hero-slider">
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('{{ asset('user/img/slider2.jpg')}}')"> 
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
				...
				<!-- Start End Slider -->
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('{{ asset('user/img/slider3.jpg')}}')"> 
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
